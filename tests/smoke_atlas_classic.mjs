...
assert.match(html, /styles\.css\?v=r189/, 'Classic Atlas styles have a fresh cache key');
assert.match(html, /apt\.js\?v=r215/, 'Classic Atlas behavior has a fresh cache key');
