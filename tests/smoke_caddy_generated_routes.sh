...
api_names=(archive birdnet-api birdnet-status birdweather config cutout export generate maintenance menu recording recording-delete reference-recording spectrogram wiki)
